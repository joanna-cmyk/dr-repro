...
export const quizQuestions: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      { label: "D", text: "It should come differently every month", isCorrect: false },
    ],
  ...
  },
  {
    ...
    options: [
      { label: "A", text: "No periods forever", isCorrect: false },
      { label: "B", text: "Ovaries make many partially grown eggs that can form cysts", isCorrect: true },
      { label: "C", text: "Ovaries are missing", isCorrect: false },
      { label: "D", text: "Only happens after 40", isCorrect: false },
    ],
    tip: "PCOD is common (1 in 5 Indian women). The ovaries produce many eggs that don't fully grow — these partly grown eggs form small pockets or tiny bubbles (cysts) inside the ovary. This causes irregular, delayed, or missed periods. Healthy eating, exercise, and doctor guidance can help manage it.",
  ...
  },
  {
    ...
    options: [
      { label: "A", text: "Rest completely and avoid water", isCorrect: false },
      { label: "B", text: "Exercise and swim safely", isCorrect: true },
      { label: "C", text: "Only light walking is allowed", isCorrect: false },
      { label: "D", text: "Swimming causes infection", isCorrect: false },
    ],
    ...
    redFlag: "If you experience dizziness, extreme fatigue, or very heavy bleeding during exercise, rest and consult a doctor if symptoms persist.",
  },
  {
    id: 8,
